...
export const gearCatalog: GearData[] = [
  {
  ...
  },
  {
    ...
    image: '/gear/tent5.jpg',
    imageAlt: 'Campsite kitchen layout with tent and mountain backdrop',
  },
]

export function getGearBySlug(slug: string): GearData | undefined {
  return gearCatalog.find((gear) => gear.slug === slug)
}

export function getGearCatalog(): GearData[] {
  return gearCatalog
}
